<template>
  <div class="bloc-modale" v-if="reveleDossier">
    <!-- if revele false le modale disparait if revele true le modale apparait -->
    <div class="overlay" v-on:click="toggleNouveauDossier"></div>
    <!-- click en dehors du modale pour fermer -->
    <form class="modale-card">
      <div v-on:click="toggleNouveauDossier" class="btn-modale">x</div>
